...
# File specifications
## File path
file_path<- "raw_data/DURIN_WP4_raw_4Corners_field_structure_trees_2025.csv"
...
## Export in CSV
write.csv(final_df_export_csv, "clean_data/DURIN_WP4_clean_4Corners_field_structure_trees_2025.csv", row.names = FALSE)
