...
# --- Vegetation measurements in Extra WP4 biomass removal plots ---- #
...
# File specifications
## File path
file_path<- "raw_data/DURIN_WP4_raw_4Corners_field_biomass_trait_cover_dwarf_shrubs_2025_OFF_SE_KA_ONLY.csv"
